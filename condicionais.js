...
// e depois informar quantas notas de cada valor serão fornecidas. As notas disponíveis serão as de 1, 5, 10, 20, 50, 100 e 200 reais.
...
// // Faça um script que leia 2 números e em seguida pergunte ao usuário qual operação ele deseja realizar.
...
// let number1 = Number(prompt.question("Digite o primero número: "));
// let number2 = Number(prompt.question("Digite o segundo número: "));

// let operacao = prompt.question("Digite a operação: ");
// let valorFinal = 0;
// switch (operacao) {
//   case "+":
...
// if (valorFinal === Math.floor(valorFinal)) {
